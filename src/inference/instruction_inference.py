...
def generate(generator, input_text, max_length=200, num_return_sequences=1):
    output = generator(input_text, max_length=200, num_return_sequences=1)[0]['generated_text']
...
def main():
    model_name_or_path = "/workspace/Coding/lm-trainer/model_records/polyglot-ko-5.8b-title-instruction-epoch_20"
